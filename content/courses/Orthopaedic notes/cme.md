...
Mirel
 ...
 - Location
 - Size
9 points or more: risk of pathological fracture more, suggesting fixation
...
### Pelvis & Periacetabular region

- Debulk
- Fill or bypass the defect 
- Durable joint reconstruction  

<font color="emerald"> Harrington classification</font>
  - 1:Intact walls
...
<font color="blue">Tokuhasi</font>

<left>9 or more points indicate longer life</left>
> - General condition
> - Neurology
...
> Tumour is  abnormal growth of tissue 

---
## Charecteristics
- Abnormal cellular proliferation
- They continues to grow after initial stimulus
- Have no structure or functional organisation
- No use to host   

- <font color="red"> Malignant tumor: Predisposition to local and distant metastatic invasion and destruction</font>
...
- <font color="Blue"> Pseudocapsule</font>: Tumor grows centrifugally to compress normal tissue
- <font color="blue"> Reactive zone</font>: Area of edema and neo vascularisation characterised by inflammatory cells and micro nodules of tumor
...
Patients usually present to a physician in 1 of 5 possible scenarios: 
- an incidentally noted lesion, 
- a painless bony mass, 
- a painful bone lesion, or 
...
The initial step in evaluation of these patients is a complete history and physical examination to determine which of these scenarios applies.

---

# History
Likely diagnoses change significantly depending on the patient’s age and location of lesion, making these the key pieces of information.
...
- Lesions seen almost exclusively in children or young adults: <font color="emerald">NOF, unicameral bone cyst, aneurysmal bone cyst, osteosarcoma, and Ewing sarcoma.</font> 

- In patients more than 40 years of age:  metastatic lesions and multiple myeloma.

- in patients of any age: Other lesions such as fibrous dysplasia, hemangioma, or infection 

---

- the location of pain, 
- onset and duration of symptoms, 
- timing of symptoms, and 
- alleviating or exacerbating factors. 
- constitutional symptoms, 
- recent changes in weight, 
- a personal history of cancer, and 

---

a family history of bone lesions or hereditary musculoskeletal conditions (eg, multiple hereditary exostoses, neurofibromatosis) should be acquired from the patient.
...
- Systemic staging
  - CT chest abdomen and pelvis, Bone scan, Bone marrow
- Never assume a solitary lesion to be metastasis, <font color="red">Do not rush to fix</font>
...
![Drain](/img/dr.png/)<figcaption>improper drain
